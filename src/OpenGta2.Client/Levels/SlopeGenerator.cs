...
public static class SlopeGenerator
{
    ...
    // face to cube
    private static readonly Matrix _matrixFaceToCubeLeft = Matrix.CreateRotationX(-MathHelper.PiOver2) *
                                             Matrix.CreateRotationZ(MathHelper.PiOver2) *
                                             Matrix.CreateTranslation(new Vector3(0, 0, 1));

    private static readonly Matrix _matrixFaceToCubeRight = Matrix.CreateRotationX(-MathHelper.PiOver2) *
                                              Matrix.CreateRotationZ(-MathHelper.PiOver2) *
                                              Matrix.CreateTranslation(new Vector3(1, 1, 1));

    private static readonly Matrix _matrixFaceToCubeTop = Matrix.CreateRotationX(-MathHelper.PiOver2) *
                                            Matrix.CreateRotationZ(MathHelper.Pi) *
                                            Matrix.CreateTranslation(new Vector3(1, 0, 1));

    private static readonly Matrix _matrixFaceToCubeBottom = Matrix.CreateRotationX(-MathHelper.PiOver2) *
